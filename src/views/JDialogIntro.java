...
public class JDialogIntro extends JDialog{
	...
	public JDialogIntro() {
		...
		txtIntro = new JLabel();
		txtIntro.setText("<html><body>Bienvenido, tu y 4 caballeros mas lucharan por la mano de la princesa <br> el ganador se llevara el maximo honor... <br> O eso cree</body></html>");
